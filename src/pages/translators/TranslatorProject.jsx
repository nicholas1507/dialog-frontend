...
import { getTranslatorProjects } from "../../api/api";
...
const ProjectTranslator = () => {
    ...
    async function load(page = 1, keyword = "") {
        ...
        setError(null);
        try {
            const data = await getTranslatorProjects({ page, limit: pagination.limit, search: keyword });
            ...
            >
                <CCardBody className="p-4 p-lg-5">
                    <div className="mb-4 pb-3 border-bottom">
                        <h2 className="fw-bold text-dark mb-3">My Assigned Projects</h2>
                                        ...
                                        <CCardBody className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 p-4">
                                            <div>
                                                ...
                                                <div className="text-muted small mb-2">
                                                    Budget: {project.budget || "-"} • {project.durationDays || "-"} Days
                                                </div>
                                                <div>
                                            ...
                                            <CButton
                                                ...
                                                onClick={() => navigate(`/translator/projects/${project.id}`)}
                                            >
                                                View Detail
                                            </CButton>
                                        </CCardBody>
